...
public class NewestPage extends Page implements MouseListener{
	JPanel p1;
	JPanel p2;
	...
	Dimension d1;
	Dimension d2;
	public NewestPage(MainPage mainPage) {
		super(mainPage);
		createCanvas();
		//생성
...
//		panels[5].setBackground(Color.gray);
	...
	public void createCanvas() {
		...
		String sql = "select filename,product_name,canloan from product order by product_id desc";
